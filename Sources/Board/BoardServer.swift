...
public final class BoardServer {
    ...
    private func registerRoutes(on server: HttpServer) {
        ...
        server.GET["/api/feishu/config"] = BoardServer.cors(BoardAPI.getFeishuConfig)
        server.PATCH["/api/feishu/config"] = BoardServer.cors(BoardAPI.updateFeishuConfig)
        server.POST["/api/feishu/test"] = BoardServer.cors(BoardAPI.testFeishuNotification)
        server.POST["/api/feishu/send-card"] = BoardServer.cors(BoardAPI.sendFeishuCard)
        server.POST["/api/feishu/create-doc"] = BoardServer.cors(BoardAPI.createFeishuDoc)
