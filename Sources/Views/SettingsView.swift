...
public struct SettingsView: View {
    ...
    private var pluginsSettings: some View {
        Form {
            ...
            Section("Info") {
                Text("Plugins extend PeerIsland to support additional AI assistants. Click a plugin to expand its settings.")
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
        }
    ...
    private var aboutSettings: some View {
        Form {
            ...
            Section("Info") {
                Text("PeerIsland displays Claude CLI session status in a Dynamic Island-style UI.")
                    .font(.caption)
                    .foregroundColor(.secondary)

                Text("GitHub: anthropics/PeerIsland")
                    .font(.caption)
                    .foregroundColor(.blue)
            }
        }
...
struct PluginRowView: View {
    ...
    private var pluginSpecificSettings: some View {
        ...
        case "com.peerisland.plugin.aime":
            AimePluginSettings()
        case "com.peerisland.plugin.cursor":
