...
class DebugExporter {
    ...
    static func export() {
        ...
        panel.nameFieldStringValue = "PeerIsland-Debug-\(timestampString()).zip"
    ...
    private static func exportToZip(_ destination: URL) throws {
        // 创建临时目录
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent("PeerIsland-Debug")
